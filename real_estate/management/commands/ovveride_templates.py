...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if os.path.exists(venv_path):
            subprocess.call("rm -rf $(pwd)/real_estate/templates/* && cp -r {}/lib/python{}/site-packages/oscar/templates/oscar/* $(pwd)/real_estate/templates && cd real_estate/templates && tree".format(venv_path, PYTHON_VERSION),shell=True)
