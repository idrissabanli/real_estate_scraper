"""
Django settings for real_estate_scraper project.
...
SECRET_KEY = "cb9s-d@$2cweew6%j@p@-p(!e8-=0o4#{SECRET_KEY}emt#-7#{SECRET_KEY}74h(9!x^4kx"
...
MIDDLEWARE = [
    ...
    'real_estate_scraper.middleware.force_default_middleware.force_default_language_middleware',
