"""RealEstateScraper URL Configuration
...
admin.site.site_header = 'RealEstateScraper Admin'
admin.site.site_title = 'RealEstateScraper Administration'
admin.site.index_title = 'RealEstateScraper Administration'
